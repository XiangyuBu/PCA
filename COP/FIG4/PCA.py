...
plt.xlabel("$y_1^2 + y_2^2$", fontsize=16, color='black', horizontalalignment='center', fontname='Brush Script MT')
...
plt.xlim(-50, 50)
plt.ylim(-50, 50)
plt.xlabel("$y_2$", fontsize=16, color='black', horizontalalignment='center', fontname='Brush Script MT')
plt.ylabel("$y_3$", fontsize=16, color='black', horizontalalignment='center',
	 	   fontname='Brush Script MT')  
...
plt.xlim(-50, 50)
plt.ylim(-50, 50)
plt.xlabel("$y_3$", fontsize=16, color='black', horizontalalignment='center', fontname='Brush Script MT')
plt.ylabel("$y_4$", fontsize=16, color='black', horizontalalignment='center',
	 	   fontname='Brush Script MT')  
